          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {sortedTeams.map((team, index) => (
              <tr key={team.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100">{team.points}</td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100">{team.wins}</td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100">{team.draws}</td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100">{team.losses}</td>
                <td className="px-6 py-4 whitespace-nowrap font-bold text-gray-900 dark:text-white">{team.points}</td>
              </tr>
            ))}
          </tbody>
        </table>
