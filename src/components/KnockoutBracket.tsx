...
export const KnockoutBracket: React.FC<KnockoutBracketProps> = ({ teams, division = 2 }) => {
  ...
  const finalsBoxClasses =
    "w-48 h-16 bg-[#169B62] dark:bg-[#0A2F51] rounded-lg p-3 flex flex-col justify-center border border-gray-200 dark:border-gray-700";
  ...
  // Function to render finals box with truncated text
  const renderFinalsBox = () => (
    <div className={finalsBoxClasses}>
      <div className="text-sm text-white truncate">Finals</div>
      <div className="font-medium text-white truncate">TBD</div>
    </div>
  );
