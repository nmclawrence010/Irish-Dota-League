...
import { Users, ClipboardList, UserPlus, User } from "lucide-react";
...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors">
      <header className="bg-gradient-to-r from-[#169B62] via-[#169B62]/80 to-[#FF883E] dark:from-[#0A2F51] dark:via-[#0E4D64] dark:to-[#137177] text-white py-6 transition-colors">
